...
- **Update notice banner** — all dashboard variants check the latest GitHub release asynchronously and show a notice only when the local stored version differs
